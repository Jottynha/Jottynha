![header](https://capsule-render.vercel.app/api?type=waving&height=200&color=0A192F)

| 🇧🇷 Português | 🇺🇸 [English Version](#coming-soon) |
|--------------|-------------------------|

# 👋 Seja bem-vindo, Viajante! 
<h2>🧠 Me chamo João Pedro Rodrigues Silva</h2>

Sou estudante de Engenharia da Computação no CEFET-MG (Campus Divinópolis), atualmente no 5º período.  
Tenho buscado desenvolver minhas habilidades em programação e explorar áreas como desenvolvimento de jogo, interfaces gráficas e lógica de programação. 
...
## 🎓 Formação Acadêmica
- 📚 Engenharia da Computação – CEFET-MG (Divinópolis) – 5º Período  
- 👨‍💻 Participação em projeto de extensão. (Prorobot)
...
![footer](https://capsule-render.vercel.app/api?type=waving&height=140&color=0A192F&section=footer)
